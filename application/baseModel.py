...
# def json_serial(obj):
#     """JSON serializer for objects not serializable by default json encode"""
...
# copyright: https://wakatime.com/blog/32-flask-part-1-sqlalchemy-models-to-json
class BaseModel(db.Model):
    ...
    def to_dict(self, show=None, _hide=None, _path=None):
        ...
        default = self._default_fields if hasattr(self, "_default_fields") else ['id']
    ...
    def to_json(self, show=None, _hide=[], _path=None):
        return json.dumps(self.to_dict(show, _hide, _path))