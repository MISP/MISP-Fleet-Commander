        ...
        <b-overlay :show="refreshInProgress" rounded="sm">
            ...
            <div>
                <b-badge variant="x" class="mb-2" style="border: 1px solid #bbb; background-color: #fff;">
                    ...
                    <span class="ml-1">Monitoring is <b-badge :variant="fleetMonitoringEnabled ? 'success' : 'danger'" style="font-size: 100%;">{{ fleetMonitoringEnabled ? 'enabled' : 'disabled' }}</b-badge></span>
                </b-badge>
            </div>
